...
GENERIC_TERMS = [
    ...
    "BROADER MARKET", "RBI", "SEBI", "FII", "DII",
    "GLOBAL CUES", "CRUDE OIL", "RUPEE", "DOLLAR",
    "INFLATION", "GDP", "ECONOMY", "ECONOMIC",
    "INTEREST RATE", "REPO RATE", "MONETARY POLICY",
    "BULL MARKET", "BEAR MARKET", "STOCK MARKET","ELECTION", "RESULTS DISAPPOINT", "MKT", "MKTS",
    "FALL 20", "FALL 10", "CORRECTION", "BLUECHIP",
    "BLUE-CHIP", "STIMULUS", "BAILOUT","BAROMETERS", "VIX", "VOLATILITY INDEX", "BREADTH",
    "BROADER INDICES", "ADVANCE DECLINE"
]
