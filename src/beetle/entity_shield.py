...
GENERIC_TERMS = [
    ...
    "PUDUCHERRY", "ALLAHABAD", "ELON MUSK", "OPENAI", "BENGALURU RAINS", "RAINS", "RAINFALL", "MONSOON",
    "FLOOD", "CYCLONE", "WEATHER","GOLD DEMAND", "WORLD GOLD COUNCIL", "WGC",
    "SILVER DEMAND", "GOLD PRICE", "DEVELOPED NATION", "JEFFREY SACHS", "GDP GROWTH",
    "ECONOMIC GROWTH", "GROWTH TRAJECTORY",
    # Weather
    "BENGALURU RAINS", "RAINS", "RAINFALL", "MONSOON", "FLOOD", "CYCLONE",
    # Gold/Commodities  
    "GOLD DEMAND", "WORLD GOLD COUNCIL", "WGC", "SILVER DEMAND", "GOLD PRICE",
    # Macro commentary
    "DEVELOPED NATION", "JEFFREY SACHS", "GROWTH TRAJECTORY", "ECONOMIC GROWTH",
]
